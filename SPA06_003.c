...
void spl07_003_init(void)
{
   ...
   // p_spl07_003->chip_id = 0x11;
    ...
    spl07_003_rateset(TEMPERATURE_SENSOR,1, 2);
    //Start background measurement
    spl07_003_start_continuous(CONTINUOUS_TEMPERATURE);
}
...
void spl07_003_get_raw_pressure(void)
{
    ...
    SoftI2C_stop();
    #else
    i2cModuleController.MultiRead_Reg(I2C1, false, HW_ADR, 0x00, 3, &val[0]);
    h = val[0];
    m = val[1];
    l = val[2];
    #endif
